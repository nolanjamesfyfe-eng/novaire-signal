...
class RenderContractTests(unittest.TestCase):
    ...
    def test_alpaca_is_canonical_live_holdings_source_with_weights(self):
        ...
        self.assertIn("Scan unverified", self.html)
        self.assertNotIn("Updated on Scan unverified", self.html)
        self.assertIn("No zero-candidate claim is being made", self.html)
        self.assertNotIn("Weekly scan awaiting verified data", self.html)
